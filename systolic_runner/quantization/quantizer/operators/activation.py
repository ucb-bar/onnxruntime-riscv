...
class QLinearActivation(QuantOperatorBase):
    ...
    def QuantizeClipRelu(self):
        ...
        if self.quantizer.input_qType == onnx_proto.TensorProto.UINT8:
        ...
        elif node.op_type == "Relu" and self.quantizer.input_qType == onnx_proto.TensorProto.INT8:
            q_input = self.quantizer.quantized_value_map[node.input[0]]
            ...
            self.quantizer.new_nodes += [qlinear_relu]
