...
TEST(SystolicMaxPoolNHWCTest, MaxPoolWithoutIndex) {
  OpTester test("MaxPool_nhwc");
  ...
  NCHWtoNHWCconvert(x_vals, x_dims);
  ...
  NCHWtoNHWCconvert(expected_vals, expected_dims);
...
TEST(SystolicMaxPoolNHWCTest, MaxPoolWithoutIndex2) {
  OpTester test("MaxPool_nhwc");
  ...
  std::vector<int64_t> x_dims = {2, 2, 3, 3};

  NCHWtoNHWCconvert(x_vals, x_dims);

  std::vector<int64_t> expected_dims = {2, 2, 2, 2};
  std::vector<float> expected_vals = {5, 6, 8, 9, 14, 15, 17, 18, -1, -2, -4, -5, -10, -11, -13, -14};
...
TEST(SystolicMaxPoolNHWCTest, MaxPoolWithIndex) {
  OpTester test("MaxPool_nhwc");
  ...
  std::vector<int64_t> expected_dims = {2, 2, 2, 2};
  std::vector<float> expected_vals = {5, 6, 8, 9, 14, 15, 17, 18, -1, -2, -4, -5, -10, -11, -13, -14};
  std::vector<int64_t> expected_vals_idx = {8, 9, 10, 11, 14, 15, 16, 17, 18, 19, 20, 21, 24, 25, 26, 27};

  NCHWtoNHWCconvert(expected_vals, expected_dims);

  test.AddInput<float>("X", x_dims, x_vals);
  test.AddOutput<float>("Y", expected_dims, expected_vals);
  test.AddOutput<int64_t>("Indices", expected_dims, expected_vals_idx);
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kTensorrtExecutionProvider});
}
