...
MLASCALL(char accelerator_mode, int dimI, int dimJ, int dimK, const int8_t* in1, const int8_t* in2, int8_t* out, int divisor, float real_multiplier, const int32_t* bias = nullptr);
#endif
//
